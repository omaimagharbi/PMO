...
async function handleSignCr(req, res) {
...
async function handleRejectAnalysis(req, res) {
  const { analysisId } = req.body || {};
...
module.exports = async function handler(req, res) {
  ...
  if (action === 'analyze-message') return handleAnalyzeMessage(req, res);
  if (action === 'sign-cr') return handleSignCr(req, res);
  if (action === 'reject-analysis') return handleRejectAnalysis(req, res);
